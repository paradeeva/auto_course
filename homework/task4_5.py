...
def josephus_task(num_people, kill_num):
    ...
    # https://ru.wikipedia.org/wiki/%D0%97%D0%B0%D0%B4%D0%B0%D1%87%D0%B0_%D0%98%D0%BE%D1%81%D0%B8%D1%84%D0%B0_%D0%A4%D0%BB%D0%B0%D0%B2%D0%B8%D1%8F
    :param: (num_people) численность воинов, стоящие в кругу
    :param: (kill_num) номер воина, которого вывели из круга
    :return: (survivor) номер воина, который остается последним - "выживший"
    """
    survivor = 0
    for n in range(1, num_people + 1):
        survivor = (survivor + kill_num) % n
    survivor = survivor + 1
    return survivor
