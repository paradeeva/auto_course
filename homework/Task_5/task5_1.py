...
def letter_stat(our_str):
    ...
    """
    Вернуть словарь, в котором ключ - буква принимаемой строки, а значение - порядковый номер вхождения данной буквы
    в принимаемую строку
    :param: (our_str) принимаемая строка
    :return: (letters_dict) словарь
    """
    letters_dict = {n: our_str.count(n) for n in our_str}
    return letters_dict
