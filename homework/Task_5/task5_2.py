...
def repeats(our_str):
    ...
    """
    Вернуть новую строку, в которой к каждому символу принимаемой строки добавлен порядковый номер вхождения этого
    символа в принимаемую строку в формате 'символ_n'
    :param: (our_str) принимаемая строка
    :return: (new_str) новая строка
    """
    new_str = ''
    letters_dict = {}
    for letter in our_str:
        if letter in letters_dict.keys():
            ...
            letters_dict[letter] = 1
        new_str = new_str + letter + '_' + str(letters_dict[letter])
    return new_str
