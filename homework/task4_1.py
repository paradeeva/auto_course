...
def which_triangle(a, b, c):
    ...
    """
    Определить можно ли построить треугольник и вывести тип треугольника в зависимости от длины сторон
    :param: (a, b, c) длины сторон
    :return: (type_triangle) Тип треугольника: Равносторонний, Равнобедренный, Обычный, Не треугольник
    """
    if a > 0 and a == b == c:
