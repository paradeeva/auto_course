...
def multiplication_chain(num):
    ...
    """
    Вернуть количество итераций, необходимое для получения одноразрядного результата от произведения цифр принятого
    числа
    :param: (num) принятое положительное число
    :return: (count_multy) колличество иттераций
    """
    count_multy = 0
    multy = 1
    temp_multy = 10
